...
class FlaskErrorCode(BaseResponseCode, Basic):
    ...
    QDRANT_CONNECTION_FAILED = ("QDRANT_CONNECTION_FAILED", 503, "Qdarnt Database와 연결에 실패했습니다.")
    QDRANT_INFO_ID_NOT_FOUND = ("QDRANT_INFO_ID_NOT_FOUND", 404, "해당 info_id의 노드를 조회할 수 없습니다.")
